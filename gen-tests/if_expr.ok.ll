...
entry:
  %$2 = icmp slt i32 %argc, 3
  br i1 %$2, label %then0, label %post0
then0:
  %$0 = call i32 (i8*) @puts(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @str.0, i64 0, i64 0))
  br label %post0
post0:
  %$3 = icmp sge i32 %argc, 3
  br i1 %$3, label %then1, label %post1
then1:
  %$1 = call i32 (i8*) @puts(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.1, i64 0, i64 0))
  br label %post1
post1:
  ret i32 0
}
